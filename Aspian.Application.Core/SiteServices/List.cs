    ...
    public class List
    {
        ...
        public class Handler : IRequestHandler<Query, List<SiteDto>>
        {
            ...
            public async Task<List<SiteDto>> Handle(Query request, CancellationToken cancellationToken)
            {
                ...
                await _logger.LogActivity(site.Id, ActivityCodeEnum.SiteList, ActivitySeverityEnum.Information,ActivityObjectEnum.Site, "Get a List of all sites infromation.");
