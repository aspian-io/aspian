...
const { SubMenu } = Menu;
const AspianMenu: FC<IProps> = ({t, pathname}) => {
  ...
  return (
    <Menu theme="dark" mode="inline" selectedKeys={[pathname]}>
      ...
      <Menu.Item key="/admin/dashboard" icon={<DashboardOutlined className="menu-icon" />}>
      ...
      <SubMenu
        key="sub7"
        icon={<FundViewOutlined className="menu-icon" />}
